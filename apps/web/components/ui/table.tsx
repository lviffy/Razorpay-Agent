...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-9 px-3 text-left align-middle font-semibold text-xs text-zinc-500 uppercase tracking-wider",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("p-3 align-middle text-xs text-zinc-700", className)}
    {...props}
  />
));
