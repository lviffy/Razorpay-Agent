...
const executionPipeline = [
  {
    ...
    badge: '120s Mutex Lock',
    desc: '1 unit of NK-PEG-40 locked in Redis to prevent race conditions.',
    icon: Lock,
    accent: 'text-amber-600 bg-amber-50 border-amber-200/80',
  },
  {
    id: 2,
    title: '2. x402 Payment Challenge',
    badge: 'HTTP 402 Header',
    desc: 'Seller Agent issues signed challenge: 3,799.00 INR (120s expiry).',
    icon: FileCode2,
    accent: 'text-brand-600 bg-brand-50 border-brand-200/80',
  },
  {
    id: 3,
    title: '3. Razorpay Order Created',
    badge: 'Orders API',
    desc: 'Idempotent Order #order_Rzp_9812401 generated on Razorpay rails.',
    icon: Zap,
    accent: 'text-blue-600 bg-blue-50 border-blue-200/80',
  },
  {
    id: 4,
    title: '4. Payment Captured',
    badge: 'HMAC Webhook',
    desc: '1-Tap UPI verified cryptographically via payment.captured webhook.',
    icon: CheckCircle2,
    accent: 'text-emerald-600 bg-emerald-50 border-emerald-200/80',
  },
  {
    id: 5,
    title: '5. Shopify Order Dispatched',
    badge: 'Fulfillment',
    desc: 'Stock state committed to PAID. Order #ORD-1042 written to Shopify.',
    icon: ShoppingBag,
    accent: 'text-emerald-600 bg-emerald-50 border-emerald-200/80',
  },
]
